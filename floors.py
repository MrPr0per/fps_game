...
def load_floor(num_floor):
    ...
    if num_floor == 19:
        floor = Floor(build_list=[
            Build(column_list=[
                ...
                Column(-4.59, 0, 3, 0),
                Column(-1.49, 0, 3, 0),
                Column(-1.52, 8.34, 3, 0),
                Column(-4.69, 8.37, 3, 0),
                Column(-4.66, 11.42, 3, 0),
                Column(-1.61, 11.45, 3, 0),
                Column(-1.36, 28, 3, 0),
                Column(15, 27.4, 3, 0),
                Column(14.54, 29.67, 3, 0),
                Column(2.31, 30, 3, 0),
                Column(3, 41, 3, 0),
                Column(25.55, 40.49, 3, 0),
                Column(21, 26, 3, 0),
                Column(4.39, 26, 3, 0),
                Column(5, 21, 3, 0),
                Column(31.67, 22, 3, 0),
                Column(32.34, 18.6, 3, 0),
                Column(41.7, 18, 3, 0),
                Column(41, 1, 3, 0),
                Column(32, -6.66, 3, 0),
            ], is_closed=False, texture_name=TEXT_STONE),
            Build(column_list=[
                Column(24.57, -6.66, 3, 0),
                Column(16.5, 0.49, 3, 0),
                Column(17, 15, 3, 0),
                Column(26.47, 18, 3, 0),
                Column(4, 18, 3, 0),
                Column(3, 12, 3, 0),
            ...
            Build(column_list=[
                Column(24.51, -6.68, 3, 0),
                Column(24.51, -14, 3, 0),
                Column(81, -14, 3, 0),
                Column(79.41, 28, 3, 0),
                Column(66.44, 51.49, 3, 0),
                Column(45, 60, 3, 0),
                Column(4, 62.31, 3, 0),
            ], is_closed=False, texture_name=TEXT_STONE),
            Build(column_list=[
                Column(32, -6, 3, 0),
                Column(32, -9, 3, 0),
                Column(63.36, -8.65, 3, 0),
                Column(61, 29, 3, 0),
                Column(42.38, 43.53, 3, 0),
                Column(-7.66, 47.39, 3, 0),
                Column(-7.45, 27, 3, 0),
                Column(-26, 26.59, 3, 0),
            ], is_closed=False, texture_name=TEXT_STONE),
            Build(column_list=[
                Column(4, 62.35, 3, 0),
                Column(-40.38, 61.37, 3, 0),
                Column(-35, 26.59, 3, 0),
                Column(-35.4, 19.44, 3, 0),
                Column(-40, 29.41, 3, 0),
            ], is_closed=False, texture_name=TEXT_STONE),
            Build(column_list=[
                Column(-52.47, 29.64, 3, 0),
                Column(-51.59, -21, 3, 0),
                Column(-42.42, -32, 3, 0),
            ], is_closed=False, texture_name=TEXT_STONE),
            Build(column_list=[
                Column(-24, -32, 3, 0),
                Column(-10.43, -23.54, 3, 0),
                Column(-9, 23.52, 3, 0),
                Column(-24.32, 24, 3, 0),
                Column(-27, 19.33, 3, 0),
                Column(-26, 27, 3, 0),
            ...
            Baggebo(x=-4.04, y=10.77, angle=331),
            Baggebo(x=5.04, y=11.37, angle=220),
            Baggebo(x=-0.24, y=26.46, angle=271),
            Baggebo(x=0.84, y=26.58, angle=267),
            Baggebo(x=1.98, y=26.69, angle=268),
            Baggebo(x=3.04, y=26.63, angle=260),
            Baggebo(x=19.04, y=8.18, angle=29),
            Baggebo(x=19.84, y=6.06, angle=48),
            Baggebo(x=21.01, y=4.03, angle=63),
            Baggebo(x=22.12, y=2.32, angle=71),
            Baggebo(x=23.74, y=0.7, angle=83),
            Baggebo(x=25.1, y=-0.21, angle=84),
            Baggebo(x=27.78, y=-1.07, angle=115),
            Baggebo(x=30.0, y=-0.21, angle=117),
            Baggebo(x=32.99, y=1.1, angle=128),
            Baggebo(x=35.41, y=3.17, angle=125),
            Baggebo(x=37.74, y=4.99, angle=138),
            Baggebo(x=37.89, y=7.88, angle=160),
            Baggebo(x=38.6, y=10.45, angle=163),
            Baggebo(x=18.73, y=10.71, angle=11),
            Baggebo(x=-9.54, y=44.65, angle=109),
            Baggebo(x=-10.16, y=43.37, angle=117),
            Baggebo(x=-11.82, y=43.65, angle=93),
            Baggebo(x=-10.38, y=45.81, angle=110),
            Baggebo(x=-10.32, y=38.7, angle=103),
            Baggebo(x=-11.55, y=40.03, angle=109),
            Baggebo(x=-10.71, y=41.76, angle=118),
            Baggebo(x=-9.1, y=39.64, angle=98),
            Baggebo(x=-8.32, y=40.53, angle=112),
            Baggebo(x=-8.82, y=42.48, angle=100),
            Baggebo(x=-12.77, y=40.81, angle=101),
            Baggebo(x=-13.99, y=38.42, angle=101),
            Baggebo(x=-12.6, y=37.64, angle=106),
            Baggebo(x=-11.05, y=37.14, angle=100),
            Baggebo(x=-8.77, y=36.53, angle=98),
            Baggebo(x=-10.38, y=35.08, angle=103),
            Baggebo(x=-13.38, y=33.86, angle=99),
            Baggebo(x=-13.38, y=35.97, angle=93),
            Baggebo(x=-14.83, y=35.58, angle=94),
            Baggebo(x=-16.1, y=36.42, angle=80),
            Baggebo(x=-15.44, y=32.86, angle=98),
            Baggebo(x=-17.72, y=34.14, angle=82),
            Baggebo(x=-12.88, y=31.3, angle=101),
            Baggebo(x=-10.32, y=32.08, angle=98),
            Baggebo(x=-9.15, y=33.3, angle=100),
            Baggebo(x=-11.93, y=33.36, angle=89),
            Baggebo(x=-41.9, y=26.13, angle=281),
            Baggebo(x=-43.96, y=25.74, angle=281),
            Baggebo(x=-46.68, y=26.3, angle=279),
            Baggebo(x=-47.02, y=24.52, angle=283),
            Baggebo(x=-45.29, y=24.52, angle=282),
            Baggebo(x=-47.02, y=22.41, angle=291),
            Baggebo(x=-48.13, y=22.52, angle=287),
            Baggebo(x=-48.63, y=24.74, angle=288),
            Baggebo(x=-50.02, y=22.8, angle=293),
            Baggebo(x=-48.8, y=26.41, angle=295),
            Baggebo(x=-42.85, y=23.57, angle=282),
            Baggebo(x=-44.91, y=22.24, angle=298),
            Baggebo(x=-40.46, y=24.8, angle=267),
            Baggebo(x=-23.89, y=20.46, angle=265),
            Baggebo(x=-20.83, y=20.74, angle=253),
            Baggebo(x=-21.94, y=21.41, angle=260),
            Baggebo(x=-21.55, y=18.79, angle=253),
            Baggebo(x=-17.38, y=20.02, angle=252),
            Baggebo(x=-18.72, y=18.74, angle=255),
            Baggebo(x=-18.5, y=22.41, angle=253),
            Baggebo(x=-13.83, y=20.63, angle=254),
            Baggebo(x=-14.77, y=17.57, angle=248),
            Baggebo(x=-11.88, y=17.51, angle=256),
        ])
    if num_floor == 20:
        floor = Floor(build_list=[
            Build(column_list=[
            ...
            Build(column_list=[
                ...
                Column(104, 72, 3, 0),
                Column(50, 116, 3, 0),
                Column(-12.98, 116, 3, 0),
                Column(-48.6, 101.36, 3, 0),
                Column(-50, 68, 3, 0),
                Column(-36, 62.84, 3, 0),
            ], is_closed=False, texture_name=TEXT_STONE),
            Build(column_list=[
                Column(-26, 63.38, 3, 0),
                Column(-9.22, 74.66, 3, 0),
                Column(-9.04, 94, 3, 0),
                Column(18, 96.88, 3, 0),
                Column(56, 78, 3, 0),
                Column(80, 32.76, 3, 0),
            ...
            Build(column_list=[
                ...
                Column(-39.02, 62, 3, 0),
                Column(-55.32, 62, 3, 0),
                Column(-53.24, 17.16, 3, 0),
                Column(-37.22, 11.12, 3, 0),
                Column(-20, -8, 3, 0),
                Column(-10.88, -8, 3, 0),
                Column(-12.94, 2, 3, 0),
                Column(-28.74, 14, 3, 0),
                Column(-14.98, 23.2, 3, 0),
                Column(-8, 63.06, 3, 0),
                Column(-22, 61.16, 3, 0),
                Column(-27.0, 56, 3, 0),
                Column(-26, 64, 3, 0),
            ...
            #     Column(-20, 0, 3, 0),
            #     Column(-20, 3, 3, 0),
            # ], is_closed=True, texture_name=TEXT_FIN),
        ], object_list=[
            End_lvl_crystal(-23, 3, next_level_number=21),
            Baggebo(x=-7.82, y=26.56, angle=8),
            Baggebo(x=-7.82, y=25.1, angle=354),
            Baggebo(x=8.14, y=26.56, angle=180),
            Baggebo(x=8.69, y=24.79, angle=188),
            Baggebo(x=-2.25, y=44.67, angle=277),
            Baggebo(x=-1.27, y=45.09, angle=274),
            Baggebo(x=0.62, y=45.34, angle=257),
            Baggebo(x=2.03, y=45.34, angle=266),
            Baggebo(x=18.18, y=24.37, angle=41),
            Baggebo(x=20.18, y=20.75, angle=60),
            Baggebo(x=22.77, y=16.3, angle=75),
            Baggebo(x=26.62, y=13.94, angle=83),
            Baggebo(x=32.25, y=12.16, angle=104),
            Baggebo(x=37.13, y=14.23, angle=115),
            Baggebo(x=42.53, y=16.38, angle=141),
            Baggebo(x=42.75, y=21.93, angle=146),
            Baggebo(x=45.05, y=27.11, angle=160),
            Baggebo(x=53.85, y=2.98, angle=141),
            Baggebo(x=49.41, y=1.06, angle=134),
            Baggebo(x=44.68, y=-1.31, angle=215),
            Baggebo(x=38.98, y=-2.79, angle=94),
            Baggebo(x=-11.27, y=90.75, angle=87),
            Baggebo(x=-12.49, y=88.63, angle=98),
            Baggebo(x=-13.71, y=90.02, angle=83),
            Baggebo(x=-15.34, y=86.68, angle=104),
            Baggebo(x=-17.29, y=88.47, angle=83),
            Baggebo(x=-12.25, y=82.44, angle=96),
            Baggebo(x=-12.98, y=84.97, angle=96),
            Baggebo(x=-17.13, y=83.01, angle=87),
            Baggebo(x=-18.76, y=85.29, angle=84),
            Baggebo(x=-15.91, y=81.06, angle=87),
            Baggebo(x=-13.63, y=80.9, angle=96),
            Baggebo(x=-15.26, y=84.48, angle=89),
            Baggebo(x=-17.05, y=78.7, angle=107),
            Baggebo(x=-20.23, y=80.57, angle=90),
            Baggebo(x=-40.06, y=59.65, angle=269),
            Baggebo(x=-42.48, y=60.28, angle=271),
            Baggebo(x=-44.9, y=59.56, angle=278),
            Baggebo(x=-46.24, y=59.65, angle=291),
            Baggebo(x=-48.12, y=60.28, angle=275),
            Baggebo(x=-49.73, y=60.1, angle=269),
            Baggebo(x=-51.7, y=59.83, angle=282),
            Baggebo(x=-20.9, y=59.3, angle=260),
            Baggebo(x=-19.11, y=59.74, angle=265),
            Baggebo(x=-16.69, y=60.28, angle=250),
            Baggebo(x=-14.0, y=60.46, angle=247),
            Baggebo(x=-11.05, y=60.73, angle=252),
            Baggebo(x=-9.8, y=60.1, angle=243),
    ...
    if num_floor == 21:
        floor = Floor(build_list=[
            ...
            End_lvl_crystal(0, 22, next_level_number=22),
            End_lvl_crystal(0, 21, next_level_number=22),
            End_lvl_crystal(0, 20, next_level_number=22),
            End_lvl_crystal(0, 19, next_level_number=22),
    ...
    if num_floor == 22:
        floor = Floor(build_list=[
            Build(column_list=[
                ...
                Column(6, -17, 3, 0),
                Column(1, -23, 3, 0),
            ], is_closed=False, texture_name=TEXT_ILLUSION_2),
            Build(column_list=[
                Column(-1, -23, 3, 0),
                Column(-6, -17, 3, 0),
                Column(-10, 1, 3, 0),
            ...
            End_lvl_crystal(0, 22, next_level_number=21),
    ...
    if num_floor == 100:
        floor = Floor(build_list=[
            ...
            Build(column_list=[
                Column(33, 4, 3, 0),
                Column(33, -8, 3, 0),
            ], is_closed=False, texture_name=TEXT_TUTOR_1),
            Build(column_list=[
                Column(-9, 8, 3, 0),
                Column(-9, 20, 3, 0),
            ], is_closed=False, texture_name=TEXT_TUTOR_2),
            Build(column_list=[
                Column(33, 36, 3, 0),
                Column(33, 24, 3, 0),
            ], is_closed=False, texture_name=TEXT_TUTOR_3),
            Build(column_list=[
                Column(-9, 40, 3, 0),
                Column(-9, 52, 3, 0),
            ], is_closed=False, texture_name=TEXT_TUTOR_4),
        ], object_list=[
            End_lvl_crystal(-2, 79, 101)
    ...
    if num_floor == 101:
        floor = Floor(build_list=[
            Build(column_list=[
                ...
                Column(-12, 83, 6, 0),
                Column(-12, 335, 6, 0),
                Column(-27, 341.69, 6, 0),
                Column(-24, 346.36, 6, 0),
                Column(-30, 364.53, 6, 0),
                Column(-24.69, 366, 6, 0),
                Column(-12.57, 381.38, 6, 0),
                Column(-8, 377, 6, 0),
                Column(0, 384, 6, 0),
            ], is_closed=False, texture_name=TEXT_WALL2),
            Build(column_list=[
                Column(0, -4, 6, 0),
                Column(12, 2, 6, 0),
                Column(10, 4, 6, 0),
            ...
            Build(column_list=[
                Column(-11, 367, 29, 0),
                Column(-6, 367, 29, 0),
            ], is_closed=False, texture_name=TEXT_WHITE),
            Build(column_list=[
                Column(6, 367, 29, 0),
                Column(11, 367, 29, 0),
            ], is_closed=False, texture_name=TEXT_WHITE),
            ...
            End_lvl_crystal(x=-0.01, y=366.99, next_level_number=102),
        ], sky_text_num=1, ground_color=(50, 50, 40))
    if num_floor == 102:
        floor = Floor(build_list=[
            Build(column_list=[
                Column(-4, 6, 3, 0),
            ...
            End_lvl_crystal(-23, 3, next_level_number=103),
            Baggebo(x=-7.82, y=26.56, angle=8),
            Baggebo(x=-7.82, y=25.1, angle=354),
            Baggebo(x=8.14, y=26.56, angle=180),
            Baggebo(x=8.69, y=24.79, angle=188),
    ...
    if num_floor == 103:
        floor = Floor(build_list=[
            Build(column_list=[
                Column(-9, -3, 3, 0),
                Column(-9, 3, 3, 0),
            ], is_closed=False, texture_name=TEXT_DOOR),
            Build(column_list=[
                Column(-9, 3, 3, 0),
                Column(6, 3, 3, 0),
                Column(6, 72, 3, 0),
            ...
            Baggebo(x=22.95, y=40.31, angle=179),
            Baggebo(x=23.36, y=38.29, angle=179),
            Baggebo(x=23.56, y=36.2, angle=184),
            Baggebo(x=23.56, y=33.78, angle=183),
            Baggebo(x=12.8, y=5.46, angle=92),
            Baggebo(x=55.31, y=58.14, angle=357),
            Baggebo(x=55.31, y=56.18, angle=2),
            Baggebo(x=55.25, y=54.03, angle=2),
            Baggebo(x=70.73, y=93.3, angle=180),
            Baggebo(x=70.63, y=86.3, angle=180),
            Baggebo(x=70.63, y=78.23, angle=177),
            Baggebo(x=64.32, y=46.81, angle=267),
            Baggebo(x=64.32, y=35.87, angle=275),
            Baggebo(x=64.32, y=22.28, angle=275),
            Baggebo(x=77.35, y=24.76, angle=357),
            Baggebo(x=77.14, y=17.02, angle=359),
            Baggebo(x=126.99, y=45.68, angle=175),
            Baggebo(x=126.86, y=37.27, angle=180),
            Baggebo(x=169.44, y=41.24, angle=4),
            End_lvl_crystal(x=172, y=41.71, next_level_number=104),
        ], ground_color=(150, 50, 50), sky_text_num=5)
    if num_floor == 104:
        floor = Floor(build_list=[
            Build(column_list=[
                Column(3, 9, 3, 0),
                ...
                Column(-12, 9, 3, 0),
                Column(-3, 9, 3, 0),
            ], is_closed=False, texture_name=TEXT_MEH),
            Build(column_list=[
                Column(-21, -12, 3, 0),
                Column(-114, 63.96, 3, 0),
                Column(-57, 217.03, 3, 0),
                Column(63, 214.07, 3, 0),
                Column(138, 100.6, 3, 0),
                Column(21, -12, 3, 0),
            ], is_closed=False, texture_name=TEXT_MEH),
            Build(column_list=[
                Column(-12, 9, 3, 0),
            ...
            Build(column_list=[
                Column(-13.98, 24, 3, 0),
                Column(-28.73, 30, 3, 0),
                Column(-29.01, 46.2, 3, 0),
                Column(15, 46.2, 3, 0),
            ], is_closed=False, texture_name=TEXT_MEH),
            Build(column_list=[
                Column(24, 33, 3, 0),
                Column(33, 57, 3, 0),
                Column(-19.5, 58.47, 3, 0),
            ], is_closed=False, texture_name=TEXT_MEH),
            Build(column_list=[
                Column(-30, 46.62, 3, 0),
                Column(-40.86, 69, 3, 0),
            ...
            Baggebo(x=-7.14, y=12.83, angle=324),
            Baggebo(x=-6.68, y=15.59, angle=307),
            Baggebo(x=-4.05, y=17.8, angle=277),
            Baggebo(x=-0.17, y=19.02, angle=250),
            Baggebo(x=4.26, y=17.89, angle=209),
            Baggebo(x=5.81, y=15.38, angle=212),
            Baggebo(x=7.54, y=12.81, angle=200),
            Baggebo(x=5.84, y=31.89, angle=346),
            Baggebo(x=5.32, y=27.74, angle=4),
            Baggebo(x=-10.66, y=33.15, angle=340),
            Baggebo(x=-12.44, y=28.41, angle=1),
            Baggebo(x=-11.55, y=43.43, angle=178),
            Baggebo(x=-10.66, y=41.73, angle=189),
            Baggebo(x=-9.77, y=39.66, angle=186),
            Baggebo(x=2.44, y=43.66, angle=176),
            Baggebo(x=3.99, y=41.95, angle=191),
            Baggebo(x=5.69, y=39.36, angle=183),
            Baggebo(x=-18.21, y=55.79, angle=355),
            Baggebo(x=-19.02, y=53.72, angle=352),
            Baggebo(x=-19.02, y=51.5, angle=349),
            Baggebo(x=-19.54, y=49.13, angle=357),
            Baggebo(x=-5.48, y=55.72, angle=349),
            Baggebo(x=-5.55, y=53.2, angle=352),
            Baggebo(x=-7.26, y=50.83, angle=353),
            Baggebo(x=-7.85, y=48.91, angle=0),
            Baggebo(x=0.83, y=55.88, angle=350),
            Baggebo(x=0.96, y=53.84, angle=261),
            Baggebo(x=0.58, y=51.02, angle=1),
            Baggebo(x=0.36, y=49.01, angle=2),
            Baggebo(x=-13.31, y=65.4, angle=183),
            Baggebo(x=-6.57, y=65.03, angle=194),
            Baggebo(x=1.79, y=63.85, angle=193),
            Baggebo(x=10.67, y=65.03, angle=198),
            Baggebo(x=17.78, y=68.29, angle=213),
            Baggebo(x=22.88, y=76.28, angle=252),
            Baggebo(x=16.52, y=79.02, angle=346),
            Baggebo(x=7.71, y=78.35, angle=0),
            Baggebo(x=-1.46, y=79.61, angle=353),
            Baggebo(x=-10.12, y=78.5, angle=356),
            Baggebo(x=-15.75, y=79.24, angle=356),
            Baggebo(x=-30.25, y=80.35, angle=330),
            Baggebo(x=-32.03, y=119.13, angle=250),
            Baggebo(x=-26.85, y=117.28, angle=227),
            Baggebo(x=-22.04, y=111.51, angle=190),
            Baggebo(x=-18.56, y=104.25, angle=171),
            Baggebo(x=-19.52, y=98.56, angle=147),
            Baggebo(x=-23.22, y=93.52, angle=125),
            Baggebo(x=-27.37, y=92.19, angle=127),
            Toflund(x=7.46, y=125.15, angle=216),
            End_lvl_crystal(x=-110.73, y=66.24, next_level_number=105),
            End_lvl_crystal(x=-52.99, y=210.91, next_level_number=105),
            End_lvl_crystal(x=61.86, y=205.36, next_level_number=105),
            End_lvl_crystal(x=127.06, y=100.5, next_level_number=105),
        ], sky_text_num=6, ground_color=(70, 40, 70))
    if num_floor == 105:
        floor = Floor(build_list=[
            Build(column_list=[
                Column(3.75, 7.5, 3, 0),
                Column(3.75, 52.5, 3, 0),
                Column(-2.04, 56.25, 3, 0),
                Column(-3.75, 63.75, 3, 0),
                Column(-1.4, 68.98, 3, 0),
                Column(3.75, 73.39, 3, 0),
                Column(11.25, 75.0, 3, 0),
                Column(16.86, 71.25, 3, 0),
                Column(18.75, 63.75, 3, 0),
                Column(18.75, 60.0, 3, 0),
                Column(15.0, 54.89, 3, 0),
                Column(12.77, 52.5, 3, 0),
            ], is_closed=False, texture_name=TEXT_SAUSAGE),
            Build(column_list=[
                Column(3.75, 7.5, 3, 0),
                Column(23.91, 7.5, 3, 0),
                Column(52.5, 22.5, 3, 0),
                Column(63.75, 37.5, 3, 0),
                Column(71.25, 50.82, 3, 0),
                Column(73.62, 71.25, 3, 0),
                Column(73.16, 84.75, 3, 0),
                Column(67.5, 101.25, 3, 0),
                Column(57.57, 117.78, 3, 0),
                Column(45.0, 125.58, 3, 0),
                Column(33.75, 126.25, 3, 0),
                Column(12.39, 126.25, 3, 0),
                Column(-12.62, 123.75, 3, 0),
                Column(-33.75, 112.5, 3, 0),
                Column(-45.0, 105.0, 3, 0),
                Column(-52.5, 91.17, 3, 0),
                Column(-52.5, 63.75, 3, 0),
                Column(-50.01, 41.25, 3, 0),
                Column(-41.25, 20.07, 3, 0),
                Column(-28.66, 11.25, 3, 0),
                Column(-11.25, 7.5, 3, 0),
            ], is_closed=False, texture_name=TEXT_SAUSAGE),
            Build(column_list=[
                Column(11.25, 75.0, 3, 0),
                Column(9.36, 112.5, 3, 0),
                Column(-2.01, 112.2, 3, 0),
                Column(-9.46, 109.5, 3, 0),
                Column(-24.0, 100.97, 3, 0),
                Column(-30.0, 90.75, 3, 0),
                Column(-34.01, 82.5, 3, 0),
            ], is_closed=False, texture_name=TEXT_SAUSAGE),
            Build(column_list=[
                Column(9.75, 112.83, 3, 0),
                Column(28.23, 113.62, 3, 0),
                Column(39.46, 109.5, 3, 0),
                Column(49.5, 97.0, 3, 0),
                Column(54.75, 86.7, 3, 0),
            ], is_closed=False, texture_name=TEXT_SAUSAGE),
            Build(column_list=[
                Column(3.0, 16.5, 3, 0),
                Column(-12.75, 18.75, 3, 0),
                Column(-18.75, 21.75, 3, 0),
                Column(-28.5, 30.75, 3, 0),
                Column(-34.8, 42.0, 3, 0),
                Column(-36.38, 51.75, 3, 0),
            ], is_closed=False, texture_name=TEXT_SAUSAGE),
            Build(column_list=[
                Column(17.61, 18.0, 3, 0),
                Column(25.5, 20.67, 3, 0),
                Column(34.09, 25.09, 3, 0),
                Column(40.74, 30.75, 3, 0),
                Column(45.75, 38.25, 3, 0),
                Column(52.5, 49.01, 3, 0),
                Column(53.72, 56.78, 3, 0),
            ], is_closed=False, texture_name=TEXT_SAUSAGE),
            Build(column_list=[
                Column(-52.5, 63.75, 3, 0),
                Column(-42.75, 63.75, 3, 0),
                Column(-37.02, 63.75, 3, 0),
                Column(-25.5, 64.84, 3, 0),
                Column(-20.55, 65.25, 3, 0),
                Column(-19.12, 75.75, 3, 0),
                Column(-15.0, 81.75, 3, 0),
                Column(-8.25, 87.75, 3, 0),
                Column(-1.5, 89.72, 3, 0),
            ], is_closed=False, texture_name=TEXT_SAUSAGE),
            Build(column_list=[
                Column(-20.7, 64.5, 3, 0),
                Column(-21.33, 57.41, 3, 0),
                Column(-19.75, 51.39, 3, 0),
                Column(-17.7, 45.0, 3, 0),
                Column(-13.5, 38.73, 3, 0),
                Column(-8.25, 35.71, 3, 0),
            ], is_closed=False, texture_name=TEXT_SAUSAGE),
            Build(column_list=[
                Column(73.5, 71.25, 3, 0),
                Column(60.22, 71.25, 3, 0),
                Column(39.0, 69.75, 3, 0),
                Column(36.75, 79.5, 3, 0),
                Column(32.76, 87.0, 3, 0),
                Column(27.75, 90.75, 3, 0),
                Column(23.25, 92.25, 3, 0),
            ], is_closed=False, texture_name=TEXT_SAUSAGE),
            Build(column_list=[
                Column(39.0, 69.75, 3, 0),
                Column(37.5, 61.19, 3, 0),
                Column(36.75, 55.5, 3, 0),
                Column(31.02, 46.77, 3, 0),
                Column(25.95, 42.34, 3, 0),
                Column(21.51, 40.5, 3, 0),
            ], is_closed=False, texture_name=TEXT_SAUSAGE),
            Build(column_list=[
                Column(-20.61, 65.25, 3, 0),
                Column(-20.71, 64.5, 3, 0),
            ], is_closed=False, texture_name=TEXT_SAUSAGE),
            Build(column_list=[
                Column(3.0, 16.5, 3, 0),
                Column(4.0, 16.5, 3, 0),
            ...
            Build(column_list=[
                Column(18.0, 17.25, 3, 0),
                Column(12.38, 53.25, 3, 0),
                Column(12.75, 52.5, 3, 0),
            ], is_closed=False, texture_name=TEXT_SAUSAGE),
            Build(column_list=[
                Column(73.5, 71.25, 3, 0),
                Column(73.5, 71.25, 3, 0),
                Column(73.5, 71.25, 3, 0),
                Column(73.5, 71.25, 3, 0),
                Column(73.2, 71.25, 3, 0),
                Column(73.88, 70.94, 3, 0),
            ], is_closed=False, texture_name=TEXT_SAUSAGE),
            Build(column_list=[
                Column(10.5, 113.25, 3, 0),
                Column(9.0, 111.75, 3, 0),
            ], is_closed=False, texture_name=TEXT_SAUSAGE),
        ], object_list=[
            End_lvl_crystal(x=7.5, y=61.5, next_level_number=106),
        ], ground_color=(200, 50, 50), sky_text_num=2)
    if num_floor == 106:
        floor = Floor(build_list=[
            Build(column_list=[
            ...
            Baggebo(x=-0.21, y=-53.74, angle=268),
            Baggebo(x=-0.27, y=-57.05, angle=270),
            Baggebo(x=-0.12, y=-58.62, angle=272),
            Baggebo(x=-0.12, y=-60.96, angle=260),
            Baggebo(x=-0.49, y=-63.58, angle=264),
            Baggebo(x=-0.41, y=-65.87, angle=276),
            Baggebo(x=-0.18, y=-68.29, angle=273),
            Baggebo(x=0.02, y=-70.17, angle=270),
            Baggebo(x=-0.01, y=-71.86, angle=264),
            Baggebo(x=-0.09, y=-73.37, angle=270),
            Baggebo(x=-0.09, y=-74.82, angle=269),
            Baggebo(x=-0.29, y=-77.45, angle=267),
            Baggebo(x=-0.27, y=-80.99, angle=269),
            Baggebo(x=0.02, y=-85.12, angle=273),
            Baggebo(x=0.02, y=-88.26, angle=258),
            Baggebo(x=-0.35, y=-90.66, angle=272),
            Baggebo(x=-0.18, y=-93.23, angle=272),
            Baggebo(x=-0.27, y=-96.62, angle=267),
            Baggebo(x=-0.24, y=-99.79, angle=272),
            Baggebo(x=-0.15, y=-102.27, angle=265),
            Baggebo(x=-0.44, y=-106.01, angle=269),
            Baggebo(x=-0.46, y=-108.32, angle=278),
            Baggebo(x=-0.18, y=-110.16, angle=275),
            Baggebo(x=0.04, y=-112.59, angle=270),
            Baggebo(x=0.01, y=-114.3, angle=265),
            Baggebo(x=-0.15, y=-116.58, angle=268),
            Baggebo(x=-0.22, y=-118.94, angle=267),
            Baggebo(x=-0.3, y=-121.52, angle=267),
            Baggebo(x=-0.37, y=-123.91, angle=256),
            Baggebo(x=-1.89, y=-125.92, angle=289),
            Baggebo(x=-3.75, y=-126.23, angle=304),
            Baggebo(x=-5.61, y=-127.29, angle=317),
            Baggebo(x=-8.2, y=-128.7, angle=325),
            Baggebo(x=-9.03, y=-130.02, angle=319),
            Baggebo(x=-10.74, y=-132.19, angle=324),
            Baggebo(x=-11.54, y=-133.75, angle=327),
            Baggebo(x=-11.88, y=-136.44, angle=340),
            Baggebo(x=-11.88, y=-138.34, angle=351),
            Baggebo(x=0.01, y=-125.51, angle=266),
            Baggebo(x=1.79, y=-125.66, angle=251),
            Baggebo(x=3.27, y=-126.87, angle=256),
            Baggebo(x=5.17, y=-127.44, angle=233),
            Baggebo(x=7.37, y=-128.32, angle=213),
            Baggebo(x=1.75, y=-128.73, angle=248),
            Baggebo(x=0.23, y=-128.13, angle=265),
            Baggebo(x=-1.66, y=-128.32, angle=280),
            Baggebo(x=-0.52, y=-129.72, angle=271),
            Baggebo(x=-1.74, y=-130.9, angle=288),
            Baggebo(x=-3.37, y=-128.96, angle=282),
            Baggebo(x=-5.12, y=-130.29, angle=307),
            Baggebo(x=-4.32, y=-130.71, angle=291),
            Baggebo(x=-3.45, y=-131.85, angle=296),
            Baggebo(x=-6.83, y=-128.96, angle=299),
            Baggebo(x=-6.41, y=-132.04, angle=314),
            Baggebo(x=-4.93, y=-132.91, angle=305),
            Baggebo(x=-7.93, y=-131.35, angle=307),
            Baggebo(x=-7.02, y=-130.67, angle=298),
            Baggebo(x=-8.84, y=-132.8, angle=310),
            Baggebo(x=-6.6, y=-134.01, angle=307),
            Baggebo(x=-4.51, y=-135.45, angle=304),
            Baggebo(x=-9.6, y=-134.62, angle=318),
            Baggebo(x=-7.28, y=-135.53, angle=325),
            Baggebo(x=-8.5, y=-136.86, angle=326),
            Baggebo(x=-9.75, y=-137.73, angle=327),
            Baggebo(x=-6.22, y=-137.09, angle=317),
            Baggebo(x=-6.56, y=-139.06, angle=330),
            Baggebo(x=-4.02, y=-137.16, angle=298),
            Baggebo(x=-3.87, y=-138.53, angle=351),
            Baggebo(x=-3.22, y=-135.61, angle=328),
            Baggebo(x=-2.04, y=-134.28, angle=287),
            Baggebo(x=-0.87, y=-133.52, angle=261),
            Baggebo(x=0.69, y=-133.44, angle=240),
            Baggebo(x=1.91, y=-134.43, angle=234),
            Baggebo(x=2.97, y=-135.64, angle=205),
            Baggebo(x=3.58, y=-136.9, angle=193),
            Baggebo(x=3.54, y=-138.19, angle=191),
            Baggebo(x=0.08, y=-131.73, angle=262),
            Baggebo(x=1.49, y=-130.52, angle=250),
            Baggebo(x=2.06, y=-131.73, angle=243),
            Baggebo(x=3.35, y=-132.57, angle=237),
            Baggebo(x=3.5, y=-130.06, angle=239),
            Baggebo(x=5.25, y=-129.83, angle=237),
            Baggebo(x=3.23, y=-128.54, angle=240),
            Baggebo(x=4.83, y=-131.54, angle=236),
            Baggebo(x=3.61, y=-134.32, angle=206),
            Baggebo(x=4.94, y=-133.21, angle=213),
            Baggebo(x=5.06, y=-135.3, angle=200),
            Baggebo(x=5.93, y=-132.04, angle=215),
            Baggebo(x=7.18, y=-130.21, angle=222),
            Baggebo(x=9.46, y=-129.91, angle=217),
            Baggebo(x=7.83, y=-132.3, angle=216),
            Baggebo(x=9.27, y=-131.77, angle=223),
            Baggebo(x=6.96, y=-134.2, angle=211),
            Baggebo(x=5.78, y=-136.67, angle=212),
            Baggebo(x=7.18, y=-138.23, angle=203),
            Baggebo(x=8.55, y=-135.34, angle=213),
            Baggebo(x=5.06, y=-138.91, angle=195),
            Baggebo(x=10.22, y=-133.56, angle=219),
            Baggebo(x=10.49, y=-136.18, angle=216),
            Baggebo(x=8.66, y=-136.97, angle=197),
            Baggebo(x=9.23, y=-138.27, angle=206),
            Baggebo(x=11.17, y=-138.27, angle=190),
            Baggebo(x=12.08, y=-136.94, angle=200),
            Baggebo(x=11.74, y=-134.7, angle=209),
            Baggebo(x=11.21, y=-131.85, angle=227),
            Baggebo(x=7.18, y=-136.02, angle=204),
            Baggebo(x=-3.34, y=-133.63, angle=312),
            Baggebo(x=-10.13, y=-136.1, angle=359),
